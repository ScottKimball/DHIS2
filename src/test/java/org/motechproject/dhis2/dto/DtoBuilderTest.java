...
public class DtoBuilderTest {
    ...
    public void setup() {
        ...
        mapper = new TrackedEntityInstanceMapper(INSTANCE_EXT_ID,null);
    ...
    public void testEntityCreation() throws Exception {
        ...
        AttributeDto testAttributeDto1 = new AttributeDto(null, "attributeUuid1", "attributeValue1");
        AttributeDto testAttributeDto2 = new AttributeDto(null,"attributeUuid2","attributeValue2");
