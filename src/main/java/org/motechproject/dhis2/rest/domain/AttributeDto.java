...
public class AttributeDto {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(id).append(created).append(name).append(href).append(lastUpdated).append(organisationUnitGroupSetAttribute).append(userGroupAttribute).append(dataElementAttribute).append(dataElementGroupAttribute).append(externalAccess).append(valueType).append(indicatorGroupAttribute).append(organisationUnitAttribute).append(mandatory).append(dataSetAttribute).append(indicatorAttribute).append(userAttribute).append(organisationUnitGroupAttribute).append(displayName).append(accessDto).append(userGroupAccesses).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeDto) == false) {
            return false;
        }
        AttributeDto rhs = ((AttributeDto) other);
        return new EqualsBuilder().append(id, rhs.id).append(created, rhs.created).append(name, rhs.name).append(href, rhs.href).append(lastUpdated, rhs.lastUpdated).append(organisationUnitGroupSetAttribute, rhs.organisationUnitGroupSetAttribute).append(userGroupAttribute, rhs.userGroupAttribute).append(dataElementAttribute, rhs.dataElementAttribute).append(dataElementGroupAttribute, rhs.dataElementGroupAttribute).append(externalAccess, rhs.externalAccess).append(valueType, rhs.valueType).append(indicatorGroupAttribute, rhs.indicatorGroupAttribute).append(organisationUnitAttribute, rhs.organisationUnitAttribute).append(mandatory, rhs.mandatory).append(dataSetAttribute, rhs.dataSetAttribute).append(indicatorAttribute, rhs.indicatorAttribute).append(userAttribute, rhs.userAttribute).append(organisationUnitGroupAttribute, rhs.organisationUnitGroupAttribute).append(displayName, rhs.displayName).append(accessDto, rhs.accessDto).append(userGroupAccesses, rhs.userGroupAccesses).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
