...
public class OrganisationUnitGroupSetDto {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OrganisationUnitGroupSetDto) == false) {
            return false;
        }
        OrganisationUnitGroupSetDto rhs = ((OrganisationUnitGroupSetDto) other);
