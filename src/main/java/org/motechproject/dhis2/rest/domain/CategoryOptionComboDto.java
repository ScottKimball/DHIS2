...
public class CategoryOptionComboDto {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(lastUpdated).append(code).append(id).append(created).append(name).append(shortName).append(href).append(externalAccess).append(displayName).append(accessDto).append(categoryComboDto).append(categoryOptionDtos).append(userGroupAccesses).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CategoryOptionComboDto) == false) {
            return false;
        }
        CategoryOptionComboDto rhs = ((CategoryOptionComboDto) other);
        return new EqualsBuilder().append(lastUpdated, rhs.lastUpdated).append(code, rhs.code).append(id, rhs.id).append(created, rhs.created).append(name, rhs.name).append(shortName, rhs.shortName).append(href, rhs.href).append(externalAccess, rhs.externalAccess).append(displayName, rhs.displayName).append(accessDto, rhs.accessDto).append(categoryComboDto, rhs.categoryComboDto).append(categoryOptionDtos, rhs.categoryOptionDtos).append(userGroupAccesses, rhs.userGroupAccesses).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
