...
public class TrackedEntityDto {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(lastUpdated).append(id).append(created).append(name).append(href).append(description).append(externalAccess).append(displayName).append(accessDto).append(userGroupAccesses).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrackedEntityDto) == false) {
            return false;
        }
        TrackedEntityDto rhs = ((TrackedEntityDto) other);
