...
public class TrackedEntityInstanceReminderDto {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrackedEntityInstanceReminderDto) == false) {
            return false;
        }
        TrackedEntityInstanceReminderDto rhs = ((TrackedEntityInstanceReminderDto) other);
